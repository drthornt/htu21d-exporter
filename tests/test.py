...
class HTU21D(object):
   def __init__(self):
      ...
      print("HTU21D.__init__() HTU21D_ADDR type {}".format(type(HTU21D_ADDR)))
      self.dev = i2c(HTU21D_ADDR, 1) #HTU21D 0x40, bus 1
      print("HTU21D.__init__() CMD_SOFT_RESET is {}".format(CMD_SOFT_RESET))
      print("HTU21D.__init__() CMD_SOFT_RESET type {}".format(type(CMD_SOFT_RESET)))
      print("Sending soft reset {}".format(CMD_SOFT_RESET))
   ...
   def read_tmperature(self):
      print("read_tmperature")
      print("write CMD_READ_TEMP_NOHOLD {}".format(CMD_READ_TEMP_NOHOLD))
